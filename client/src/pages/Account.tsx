                  ...
                  >
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                          ...
                          {order.items
                            ...
                            .map((item, index) => (
                              <img
                                ...
                                alt={item.name}
                                className="size-12 rounded-xl border-2 border-white bg-slate-100 object-cover"
                              />
                            ))}
                        </div>
                      ...
                      <div className="flex items-center justify-between gap-4 lg:justify-end">
                        <span
                          className={`inline-flex items-center gap-2 rounded-full px-3 py-2 text-xs font-semibold ${getStatusClass(
                            order.status,
                          )}`}
                        >
